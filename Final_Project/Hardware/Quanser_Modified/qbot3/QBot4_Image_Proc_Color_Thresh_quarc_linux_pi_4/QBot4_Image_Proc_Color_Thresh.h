/*
 * QBot4_Image_Proc_Color_Thresh.h
 *
...
#ifndef RTW_HEADER_QBot4_Image_Proc_Color_Thresh_h_
#define RTW_HEADER_QBot4_Image_Proc_Color_Thresh_h_
#ifndef QBot4_Image_Proc_Color_Thresh_COMMON_INCLUDES_
#define QBot4_Image_Proc_Color_Thresh_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                      /* QBot4_Image_Proc_Color_Thresh_COMMON_INCLUDES_ */

#include "QBot4_Image_Proc_Color_Thresh_types.h"
...
#define QBot4_Image_Proc_Color_Thresh_rtModel RT_MODEL_QBot4_Image_Proc_Col_T

/* Block signals (default storage) */
typedef struct {
  uint8_T MatrixConcatenate[1843200];  /* '<Root>/Matrix Concatenate' */
  uint8_T rhr[76800];
  uint8_T rhr_m[25600];
  uint8_T rhg[25600];
  uint8_T rhb[25600];
  ...
  t_channel Channel_g;                 /* '<S5>/Channel' */
  uint8_T Video3DCapture_o1[921600];   /* '<Root>/Video3D Capture' */
  uint8_T Reshape[3];                  /* '<Root>/Reshape' */
  uint8_T histogram_image[230400];     /* '<Root>/histogram_image' */
  uint8_T filtered_image[921600];      /* '<Root>/filtered_image' */
  uint8_T ImageCompress[230400];       /* '<S4>/Image Compress' */
  uint8_T ImageCompress_e[1843200];    /* '<S5>/Image Compress' */
  boolean_T Video3DCapture_o4;         /* '<Root>/Video3D Capture' */
} B_QBot4_Image_Proc_Color_Thre_T;
...
typedef struct {
  ...
  t_jpeg_compress ImageCompress_Compress_o;/* '<S5>/Image Compress' */
  ...
  int32_T ImageCompress_DIMS1_c;       /* '<S5>/Image Compress' */
  int32_T sfEvent;                     /* '<S1>/Color thresholding' */
  uint32_T HILInitialize_POSortedChans[2];/* '<Root>/HIL Initialize' */
  int8_T ImageThresholdingEnabled_Subsys;
                                    /* '<Root>/ Image Thresholding (Enabled)' */
  uint8_T ImageCompress_ScanLine[6144];/* '<S4>/Image Compress' */
  uint8_T ImageCompress_ScanLine_h[30720];/* '<S5>/Image Compress' */
  uint8_T is_active_c2_QBot4_Image_Proc_C;/* '<S1>/Color thresholding' */
  boolean_T HILInitialize_DOBits[3];   /* '<Root>/HIL Initialize' */
  boolean_T doneDoubleBufferReInit;    /* '<S1>/Color thresholding' */
} DW_QBot4_Image_Proc_Color_Thr_T;

/* Backward compatible GRT Identifiers */
#define rtB                            QBot4_Image_Proc_Color_Thresh_B
#define BlockIO                        B_QBot4_Image_Proc_Color_Thre_T
#define rtP                            QBot4_Image_Proc_Color_Thresh_P
#define Parameters                     P_QBot4_Image_Proc_Color_Thre_T
#define rtDWork                        QBot4_Image_Proc_Color_Thres_DW
#define D_Work                         DW_QBot4_Image_Proc_Color_Thr_T

/* Parameters (default storage) */
struct P_QBot4_Image_Proc_Color_Thre_T_ {
  real_T thtype1_thrtype;              /* Mask Parameter: thtype1_thrtype
  ...
  real_T Video3DCapture_Emitter;       /* Expression: emitter
                                        * Referenced by: '<Root>/Video3D Capture'
                                        */
  real_T roi1_Value[4];                /* Expression: [150 450 50 250]
                                        * Referenced by: '<Root>/roi1'
                                        */
  real_T red_th_Value[2];              /* Expression: [180 255]
                                        * Referenced by: '<Root>/red_th'
                                        */
  real_T green_th_Value[2];            /* Expression: [180 255]
                                        * Referenced by: '<Root>/green_th'
                                        */
  real_T blue_th_Value[2];             /* Expression: [80 140]
                                        * Referenced by: '<Root>/blue_th'
                                        */
  real_T truncval1_Value[3];           /* Expression: [255 255 255]
  ...
  boolean_T VideoDisplay_UseHardware;
                                  ...
                                  */
  boolean_T VideoDisplay_UseHardware_j;
...
struct tag_RTM_QBot4_Image_Proc_Colo_T {
  const char_T *path;
...
extern P_QBot4_Image_Proc_Color_Thre_T QBot4_Image_Proc_Color_Thresh_P;

/* Block signals (default storage) */
extern B_QBot4_Image_Proc_Color_Thre_T QBot4_Image_Proc_Color_Thresh_B;

/* Block states (default storage) */
extern DW_QBot4_Image_Proc_Color_Thr_T QBot4_Image_Proc_Color_Thres_DW;
...
extern void QBot4_Image_Proc_Color_Thresh_initialize(void);
extern void QBot4_Image_Proc_Color_Thresh_output0(void);
extern void QBot4_Image_Proc_Color_Thresh_update0(void);
extern void QBot4_Image_Proc_Color_Thresh_output1(void);
extern void QBot4_Image_Proc_Color_Thresh_update1(void);
extern void QBot4_Image_Proc_Color_Thresh_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QBot4_Image_Proc_Color_Thresh_rtModel *QBot4_Image_Proc_Color_Thresh(void);
...
extern RT_MODEL_QBot4_Image_Proc_Col_T *const QBot4_Image_Proc_Color_Thres_M;
 ...
 *
 * '<Root>' : 'QBot4_Image_Proc_Color_Thresh'
 * '<S1>'   : 'QBot4_Image_Proc_Color_Thresh/ Image Thresholding (Enabled)'
 * '<S2>'   : 'QBot4_Image_Proc_Color_Thresh/Powered by QUARC'
 * '<S3>'   : 'QBot4_Image_Proc_Color_Thresh/Quanser'
 * '<S4>'   : 'QBot4_Image_Proc_Color_Thresh/Video Compressed Display (Histogram)'
 * '<S5>'   : 'QBot4_Image_Proc_Color_Thresh/Video Compressed Display (RGB & Blob)'
 * '<S6>'   : 'QBot4_Image_Proc_Color_Thresh/thtype1'
 * '<S7>'   : 'QBot4_Image_Proc_Color_Thresh/ Image Thresholding (Enabled)/Color thresholding'
 * '<S8>'   : 'QBot4_Image_Proc_Color_Thresh/ Image Thresholding (Enabled)/Image Channels'
 */
#endif                         /* RTW_HEADER_QBot4_Image_Proc_Color_Thresh_h_ */
