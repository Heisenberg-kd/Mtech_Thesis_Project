...
typedef RT_MODEL_QBot4_Image_Proc_Col_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QBot4_Image_Proc_Color_Thresh(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QBot4_Image_Proc_Color_Thres_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QBot4_Image_Proc_Color_Thresh -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QBot4_Image_Proc_Color_Thresh();
  if (rtmGetErrorStatus(S) != NULL) {
