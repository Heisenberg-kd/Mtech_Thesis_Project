...
typedef RT_MODEL_qbot_driver_v_1_22_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * qbot_driver_v_1_22(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(qbot_driver_v_1_22_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: qbot_driver_v_1_22 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
      ...
      if (result == 0) {
        ...
        if (result == 0) {
          ...
          if (result == 0) {
            ...
            {
              pstream_shutdown(qbot_driver_v_1_22_DW.StreamServer_Stream);
            }
