...
typedef RT_MODEL_qbot_driver_v_1_22_2_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * qbot_driver_v_1_22_2nd_qbot4(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(qbot_driver_v_1_22_2nd_qbot4_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: qbot_driver_v_1_22_2nd_qbot4 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = qbot_driver_v_1_22_2nd_qbot4();
  if (rtmGetErrorStatus(S) != NULL) {
