...
RT_MODEL_hardware_IOTest_T *hardware_IOTest(void)
{
  ...
  /* External mode info */
  hardware_IOTest_M->Sizes.checksums[0] = (493817667U);
  hardware_IOTest_M->Sizes.checksums[1] = (2014485566U);
  hardware_IOTest_M->Sizes.checksums[2] = (241690386U);
  hardware_IOTest_M->Sizes.checksums[3] = (318404544U);
