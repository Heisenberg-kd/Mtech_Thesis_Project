...
RT_MODEL_RGBD_Imaging_T *RGBD_Imaging(void)
{
  ...
  /* External mode info */
  RGBD_Imaging_M->Sizes.checksums[0] = (272864406U);
  RGBD_Imaging_M->Sizes.checksums[1] = (2386663766U);
  RGBD_Imaging_M->Sizes.checksums[2] = (3663488533U);
  RGBD_Imaging_M->Sizes.checksums[3] = (1289517748U);
